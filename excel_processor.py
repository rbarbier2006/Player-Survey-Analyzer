...
def col_letter_to_index(col_letter: str) -> int:
    """
    Convert an Excel column letter (e.g. 'A', 'G', 'AA')
...
def append_summary_tables(
    ...
    """
    Append the rating and yes/no summary tables to a sheet.
...
def append_detail_tables(
    ...
    - "1-3 Star Reviews" section listing all players who gave 1, 2, or 3 stars.
    - "NO Replies" section listing all players who answered "NO" to Yes/No questions.
    """
